...
import 'package:renterii/Config/app_config.dart';
import 'dart:async';
...
//
  ...
  String? get deals {
    return AppConfig.languagesSupported[locale.languageCode]!.values['deals'];
  }
  ...
  String? get nearyou1 {
    return AppConfig.languagesSupported[locale.languageCode]!.values['nearyou1'];
  }
