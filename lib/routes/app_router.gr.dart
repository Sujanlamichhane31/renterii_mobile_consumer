...
import '../shops/data/models/shop.dart' as _i28;
...
class AppRouter extends _i26.RootStackRouter {
  ...
  final Map<String, _i26.PageFactory> pagesMap = {
    ...
    ConfirmOrderScreenRoute.name: (routeData) {
      final args = routeData.argsAs<ConfirmOrderScreenRouteArgs>();
      return _i26.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i6.ConfirmOrderScreen(key: args.key, shop: args.shop));
    },
...
class ConfirmOrderScreenRoute
    extends _i26.PageRouteInfo<ConfirmOrderScreenRouteArgs> {
  ConfirmOrderScreenRoute({_i27.Key? key, required _i28.Shop shop})
      : super(ConfirmOrderScreenRoute.name,
            path: '/confirm-order-screen',
            args: ConfirmOrderScreenRouteArgs(key: key, shop: shop));

  static const String name = 'ConfirmOrderScreenRoute';
}

class ConfirmOrderScreenRouteArgs {
  const ConfirmOrderScreenRouteArgs({this.key, required this.shop});

  final _i27.Key? key;

  final _i28.Shop shop;

  @override
  String toString() {
    return 'ConfirmOrderScreenRouteArgs{key: $key, shop: $shop}';
  }
}
...
class ShopScreenRouteArgs {
  ...
  @override
  String toString() {
    return 'ShopScreenRouteArgs{id: $id, key: $key, name: $name, address: $address, lat: $lat, long: $long, description: $description, reference: $reference, ratingArray: $ratingArray, rating: $rating, ratingNumber: $ratingNumber, isBooking: $isBooking, shop: $shop}';
  }
}
...
class ShopsScreenRoute extends _i26.PageRouteInfo<ShopsScreenRouteArgs> {
  ShopsScreenRoute(
      ...
      bool? isBooking,
      required _i29.DocumentReference<Object?> categoryId})
...
class ShopsScreenRouteArgs {
  ...
  final _i29.DocumentReference<Object?> categoryId;
