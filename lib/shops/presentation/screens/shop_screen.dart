              ...
              appBar: PreferredSize(
                ...
                child: CustomAppBar(
                  ...
                  bottom: PreferredSize(
                    ...
                    child: InkWell(
                      onTap: () {
                        if(!widget.ratingNumber.isNaN && widget.ratingNumber != 0) {
                          final user = context.read<UserCubit>().state.user;
                          context.router.push(ReviewsScreenRoute(shopName: widget.name, ratings: widget.ratingArray, ratingNumber: widget.rating, username: user.name, numberOfReviews: widget.ratingNumber));
                        }else {
                          ...
                          //   );
                          // final user = context.read<UserCubit>().state.user;
                          context.router.push(ReviewsScreenRoute(shopName: widget.name, ratings: [], ratingNumber: widget.rating, username: '', numberOfReviews: 0));
                        }
                      },
                      child: Column(
